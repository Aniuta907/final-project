		...
		<div class="card-deck">
			...
			<div class="card" className="pokCard">
				...
				<div class="card card-block text-center"> 
					<a href="#" class="card-link" class="card-header">Pokemon</a>
  				</div>
  				
				<div class="card card-block text-center">  				
					<img src={pokPicture1} className="pokImg" alt="Card image"/>
  					<p class="card-text" className="pokName">name: {data.pokemons[0].name}</p>
			...
			<div class="card" className="pokCard">
				...
				<div class="card card-block text-center">
					<img src={pokPicture2} className="pokImg" alt="Card image"/>
  					<p class="card-text" className="pokName">name: {data.pokemons[1].name}</p>
					<a href="#" class="btn btn-primary">Catch</a>
  				</div>
...
<img src={pokPicture3} className="pokImg" alt="Card image"/>
	  <p class="card-text" className="pokName">name: {data.pokemons[2].name}</p>
	<a href="#" class="btn btn-primary">Catch</a>
  </div>
